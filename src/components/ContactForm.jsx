...
export default function ContactForm() {
  return (
    <section id="contato" className="w-full py-16 px-4 flex justify-center bg-gray-50">
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-8 bg-white/80 p-6 md:p-12 rounded-xl shadow-md">
        ...
        <div className="flex-1 w-full">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">
            Pronto para <span className="text-red-700">transformar</span> seu sorriso?
          </h2>
          <p className="text-gray-700 mb-6">
            Agende agora mesmo sua avaliação com nossos especialistas e descubra o melhor caminho para o sorriso que você sempre desejou.
          </p>
          ...
          <form className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-sm text-gray-700 mb-1">Qual serviço você tem interesse?</label>
        ...
        <div className="flex-1 w-full flex justify-center items-end">
          <div
            className="relative w-full max-w-[300px] md:max-w-[400px] lg:max-w-[450px] rounded-3xl overflow-hidden"
            style={{
